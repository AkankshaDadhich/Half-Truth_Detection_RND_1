...
def load_and_prepare_data(csv_file_path):
    ...
    feature_columns = ['Factual Accuracy', 'Deceptiveness','Specificity','Emotional Tone','Temporal Consistency']
...
# train_model('/home/akanksha-dadhich/Desktop/nlp rnd/new_features/DATA - newfeatures.csv')  # Replace 'DATA - final.csv' with your actual CSV file path
train_model('/home/akanksha-dadhich/Desktop/nlp rnd/new_features/output_with_match_column1.csv')

# train_model('/home/akanksha-dadhich/Desktop/nlp rnd/new_features/DATA - Copy of newfeatures.csv')
