...
def load_and_prepare_data(csv_file_path):
    ...
    feature_columns = ['Factual Accuracy', 'Deceptiveness']
...
# Early stopping callback
    ...
    model = keras.Sequential([
        layers.Dense(10, activation='relu', input_shape=(X_train.shape[1],)),  # Input layer
        layers.Dense(12, activation='relu'),  # Hidden layer
...
# train_model('/home/akanksha-dadhich/Desktop/nlp rnd/DATA - testdata_decisiontree.csv')  # Replace 'DATA - final1.csv' with the actual file path
