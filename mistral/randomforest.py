...
def load_and_prepare_data(csv_file_path):
    ...
    feature_columns =['Factual Accuracy', 'Deceptiveness','Coherence','Specificity','Emotional Tone',
                      'Scope/Generality','Temporal Consistency','Out of Context or Ambiguity']
...
train_model('/home/akanksha-dadhich/Desktop/nlp rnd/mistral/output.csv')  # Replace 'your_csv_file.csv' with the actual file path
...
# new_data = [[0.5, 0.7]]  # Test data
# new_data1 = [[0.8, 0.4]]  # Example data point for prediction
