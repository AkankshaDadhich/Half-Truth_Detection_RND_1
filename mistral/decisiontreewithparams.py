...
def load_and_prepare_data(csv_file_path):
    ...
    feature_columns =  ['Factual Accuracy', 'Deceptiveness','Emotional Tone',
...
train_model('/home/akanksha-dadhich/Desktop/nlp rnd/mistral/output.csv')  # Replace 'DATA - final.csv' with your actual CSV file path
